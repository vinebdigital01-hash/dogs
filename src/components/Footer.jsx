  ...
  return (
    <footer className="bg-brand-ink text-white">
          ...
          <div className="mt-5 flex gap-3">
            {[
              ...
              <a
                ...
                aria-label={label}
                className="grid h-10 w-10 place-items-center rounded-full bg-white/10 text-white transition hover:bg-brand-teal"
              >
      ...
      <div className="border-t border-white/10">
        <div className="section grid gap-3 py-6 text-center text-xs text-white/55 sm:grid-cols-3 sm:items-center">
